...
app.post('/upload',upload.single('product'),(req,res)=>{
    res.json({
        success:1,
        image_url:`https://ecommerce-1-a8sa.onrender.com/images/${req.file.filename}`
...
// creatinh endpoint for newcollection data
...
// creating endpoint to remove the cartData
